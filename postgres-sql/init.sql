...
CREATE TABLE TB_PAIR(
    ...
    USER_SN_FROM INTEGER NOT NULL, /* 페어 요청자 */
    USER_SN_TO INTEGER, /* 페어 수락자 */
...
CREATE TABLE TB_CATEGORY( /* 카테고리는 페어끼리 공유 */
    ...
    CONSTRAINT CATEGORY_FK FOREIGN KEY(PAIR_SN) REFERENCES TB_PAIR(PAIR_SN) ON DELETE CASCADE
);
...
CREATE TABLE TB_MENU(
    ...
    CONSTRAINT MENU_FK_2 FOREIGN KEY(PAIR_SN) REFERENCES TB_PAIR(PAIR_SN) ON DELETE CASCADE
);
